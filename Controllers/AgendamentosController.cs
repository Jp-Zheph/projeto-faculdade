...
namespace NewSIGASE.Controllers
{
    public class AgendamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdSala,Data,IdUsuario,Status")] Agendamento agendamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdSala,Data,IdUsuario,Status")] Agendamento agendamento)
        {
