...
namespace NewSIGASE.Controllers
{
    public class EquipamentosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Serial,Nome,Modelo")] Equipamento equipamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Serial,Nome,Modelo")] Equipamento equipamento)
        {
