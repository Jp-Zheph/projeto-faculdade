...
namespace NewSIGASE.Migrations
{
    ...
    [Migration("20201108005539_Altera_Equipamento_Add_Marca")]
    partial class Altera_Equipamento_Add_Marca
    {
            ...
            modelBuilder.Entity("NewSIGASE.Models.SalaEquipamento", b =>
                {
                    ...
                    b.HasKey("SalaId", "EquipamentoId");

                    b.HasIndex("EquipamentoId")
                        .HasName("UN_SalaEquipamento_EquipamentoId");

                    b.HasIndex("SalaId")
                        .HasName("UN_SalaEquipamento_SalaId");
            ...
            modelBuilder.Entity("NewSIGASE.Models.SalaEquipamento", b =>
                {
                    b.HasOne("NewSIGASE.Models.Equipamento", "Equipamento")
                        .WithOne("SalaEquipamento")
                        .HasForeignKey("NewSIGASE.Models.SalaEquipamento", "EquipamentoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
